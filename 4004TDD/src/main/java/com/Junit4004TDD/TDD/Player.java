...
public class Player implements Serializable {
		...
		if (i == 12) {
			if (yahtzeeB == false) {
				...
				if (YahtzeeBonus(z) == false) {
					System.out.println(
							"Not able to score in the same numbered upper section since it is already taken so you must choose another place to score!");
					dg.fh = true;
					dg.sseq = true;
					dg.lseq = true;
	...
	public String sPrint(int i) {
		if (i == 1) {
			if (acesB == true) {
				return String.valueOf(aces);
			}
		}
		if (i == 2) {
			if (twosB == true) {
				return String.valueOf(twos);
			}
		}
		if (i == 3) {
			if (threesB == true) {
				return String.valueOf(threes);
			}
		}
		if (i == 4) {
			if (foursB == true) {
				return String.valueOf(fours);
			}
		}
		if (i == 5) {
			if (fivesB == true) {
				return String.valueOf(fives);
			}
		}
		if (i == 6) {
			if (sixesB == true) {
				return String.valueOf(sixes);
			}
		}
		if (i == 7) {
			if (ThreeKB == true) {
				return String.valueOf(threeOfKind);
			}
		}
		if (i == 8) {
			if (FourKB == true) {
				return String.valueOf(fourOfKind);
			}
		}
		if (i == 9) {
			if (fullB == true) {
				return String.valueOf(fullHouse);
			}
		}
		if (i == 10) {
			if (smB == true) {
				return String.valueOf(smStraight);
			}
		}
		if (i == 11) {
			if (lB == true) {
				return String.valueOf(lgStraight);
			}
		}
		if (i == 12) {
			if (yahtzeeB == true) {
				return String.valueOf(Yahtzee);
			}
		}
		if (i == 13) {
			if (chanceB == true) {
